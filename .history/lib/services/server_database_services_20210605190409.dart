...
class ServerDatabaseServices {
  ...
  void logCreateEvent(DatabaseAction eventType, Book book) {
    ...
    ParseObject('Event')
      ..set('previousValue', event.previousBookValue)
      ..set('updatedBookValue', event.updatedBookValue)
      ..set('dateAdded', event.dateAdded)
      ..set('entryAction', event.entryAction)
      ..set('lastModified', event.lastModified);
  }
}
