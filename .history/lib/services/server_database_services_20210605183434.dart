...
class ServerDatabaseServices {
  ...
  void logCUDEvent(DatabaseAction eventType, Book book) {
    final event = DatabaseSyncItem(previousBookValue: null, updatedBookValue: book, dateAdded: book.dateAdded, entryAction: eventType, lastModified: DateTime.now());
    (event.entryAction == DatabaseAction.create)
    ? book.toJson()
  }
}
