...
class ServerDatabaseServices {
  ...
  void logCUDEvent(DatabaseAction eventType, Book book) {
    final DatabaseSyncItem event = DatabaseSyncItem(previousBookValue: null, updatedBookValue: book, dateAdded: book.dateAdded, entryAction: eventType, lastModified: DateTime.now());
